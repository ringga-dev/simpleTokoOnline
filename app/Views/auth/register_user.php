...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url('tamplate/admin') ?>/index2.html"><b>Register</b>USER</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?= base_url() ?>/auth/save_user_pos" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="name" class="form-control <?= ($validation->hasError('name') ? 'is-invalid' : '') ?>" placeholder="name" name="name" id="name" autofocus value="<?= old('name') ?>">
                        <div class="input-group-append">
                            <div class="input-group-text">
                ...
                <p class="mb-0">
                    <a href="<?= base_url() ?>/auth/login_user" class="text-center">Login user</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
